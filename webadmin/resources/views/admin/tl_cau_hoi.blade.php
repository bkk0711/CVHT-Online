...
<form action="{{URL::to('tl_cau_hoi')}}" method="post">
@csrf
...
<br/>
    ...
    <input type="text" class="form-control" name="tu_khoa" value="{{$cau_hoi->}}">

<br/><div class="input-group">
<input type="submit" class="btn btn-warning" value=" Trả lời câu hỏi">
</div>
</form>
    </div>
    <!-- /.card-body -->
